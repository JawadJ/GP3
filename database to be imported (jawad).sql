...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2018 at 06:57 PM
...
CREATE TABLE IF NOT EXISTS `driveridcard` (
  `CardID` varchar(8) COLLATE utf8mb4_unicode_ci NOT NULL,
...
('00000001', '00000008', '2018-02-21', '2019-03-23', 'Valid'),
('00000002', '00000006', '2017-11-12', '2018-12-25', 'Valid'),
('00000003', '00000002', '2017-12-18', '2019-01-29', 'Valid'),
('00000004', '00000011', '2018-04-23', '2019-06-27', 'Valid'),
('00000005', '00000007', '2018-05-12', '2019-07-19', 'Valid'),
('00000006', '00000004', '2018-06-14', '2019-07-23', 'Valid'),
('00000007', '00000001', '2016-03-28', '2017-08-16', 'Expired'),
('00000008', '00000003', '2016-05-29', '2019-10-22', 'Cancelled'),
('00000009', '00000005', '2017-06-06', '2019-08-09', 'Valid'),
('00000010', '00000009', '2014-12-09', '2016-11-11', 'Expired'),
('00000011', '00000010', '2018-01-27', '2019-12-12', 'Valid'),
('00000012', '00000012', '2016-01-01', '2019-12-31', 'Cancelled ');
