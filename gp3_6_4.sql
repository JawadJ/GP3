...
(9, 'Ongoing', '2018-10-20', '1', '4', '1', '2', '2'),
...
CREATE TABLE IF NOT EXISTS `entrylog` (
  ...
  `Allowed` varchar(12) COLLATE utf8_unicode_ci DEFAULT 'Unauthorised',
  PRIMARY KEY (`EntryID`)
...
(1, '1', '2018-10-20', '4', '8', 'Authorised'),
(2, '1', '2018-10-20', '5', '6', 'Authorised'),
(3, '4', '2018-10-24', '6', '7', 'Authorised'),
(5, '1', '2018-10-20', '2', '1', 'Unauthorised'),
(6, '4', '2018-10-24', '5', '7', 'Unauthorised'),
(7, '1', '2018-10-21', '4', '8', 'Unauthorised'),
(8, '2', '2018-10-20', '4', '8', 'Unauthorised'),
(9, '2', '2018-10-22', '4', '6', 'Authorised');
